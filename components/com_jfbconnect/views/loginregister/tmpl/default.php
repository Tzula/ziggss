            ...
            <form action="" method="post" name="form">
                <fieldset>
                    ...
                    <dl>
                        ...
                        <dd><input type="text" class="input-medium" name="username" value="" size="20" /></dd>
                ...
                <?php foreach ($this->form->getFieldsets() as $fieldset): // Iterate through the form fieldsets and display each one.?>
                    ...
                    <?php if (count($fields))
                    {
                        ...
                        <fieldset>
                            ...
                            <?php } ?>
                            <dl>
                                <?php foreach ($fields as $key => $field): // Iterate through the fields in the set and display them.?>

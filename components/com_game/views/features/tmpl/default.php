	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="features"> 
	<div id="sectionHeader" class="beefitup"><span><h1><?php echo $this->item->name . ' ';?>Features</h1></span></div>
	<div class="gvpricon">
	...
	<div class="mostrecent">
					...
					<?php if (!empty($this->items)) : ?>
						...
						?>
									...
									<li>
										<h3><a href="<?php echo $link;?>" sl-processed="1"><?php echo $row->title;?></a> 
										</h3>
										<p><?php echo substr(strip_tags($row->text), 0, 500) . '...'; ?>

</p>
										<span class="date">Posted on <?php echo JHtml::_('date', $row->created, JText::_('DATE_FORMAT_LC4')); ?> by <a href="http://www.mmorpg.com/profile.cfm/username/Adele" sl-processed="1"><?php echo $row->author_name;?></a></span>
									</li>
					<?php endforeach; ?>
			<?php endif; ?>

...
?>
	...
	<div class="gvew2">
		...
		<div class="navgvtwo">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_game&view=videos&id=' . $this->item->id); ?>" class="videos last current" sl-processed="1"><span>Videos</span></a>
	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="videos"> 
						<div id="sectionHeader"><span><h1><a href="<?php echo JRoute::_('index.php?option=com_game&view=game&id=' . $this->item->id)?>"><?php echo $this->item->name . ' ';?>Videos:</a> <?php echo $this->video->title . ' ';?></h1>
		<h2><?php echo $this->video->introtext;?></h2></span></div>
	...
	<div class="gvpricon">
		...
		<div class="videoplayer player">
			...
			<div class="newinsideframe">
			
			<div class="frame">
				<div class="player_flash">
					
				<?php echo $this->video->text;?>
				...
				<div class="info">
					<span class="details">
						Views: <?php echo $this->video->hits;?><br>
						Game: <a href="<?php echo JRoute::_('index.php?option=com_game&view=game&id=' . $this->item->id)?>"><?php echo $this->item->name . ' ';?></a>
				...
				<div class="features"><h2>Other Videos Of This Game</h2>
					<ul class="spotlight">
						<?php if (!empty($this->videosOfThisGame)) : ?>
						<?php $count = count($this->videosOfThisGame);?>
						<?php foreach ($this->videosOfThisGame as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=video&id=' . $row->gameid . '&videoid=' . $row->id);
				...
				<div class="features"><h2>Other Videos Of This Category</h2>
					<ul class="spotlight">
						<?php if (!empty($this->videosOfThisCategory)) : ?>
						<?php $count = count($this->videosOfThisCategory);?>
						<?php foreach ($this->videosOfThisCategory as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=video&id=' . $row->gameid . '&videoid=' . $row->id);
							$img = json_decode($row->images)->image_intro;
							if ($img == ''){
								$img = 'media/other/generic.png';

	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="news"> 
	<div id="sectionHeader" class="beefitup"><span><h1><?php echo $this->item->name . ' ';?>News</h1></span></div>
	<div class="gvpricon">

	<h2>Latest Headlines for <?php echo $this->item->name;?></h2>
	
	<div class="listing">
					<ul>
					<?php if (!empty($this->items)) : ?>
						<?php foreach ($this->items as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=new&id=' . $this->item->id . '&newsid=' . $row->id);
						?>
					
									<li>
								<h3 class="title"><a href="<?php echo $link;?>" sl-processed="1"><?php echo $row->title;?></a> 
								</h3>
								
									<p class="overview"><?php echo substr(strip_tags($row->text), 0, 500) . '...'; ?></p>
								
								<span class="date">Reported on <?php echo JHtml::_('date', $row->created, JText::_('DATE_FORMAT_LC4')); ?></span>
							</li>
					<?php endforeach; ?>
			<?php endif; ?>

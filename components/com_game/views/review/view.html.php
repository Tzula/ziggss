 ...
 * @since  0.0.1
 */
class GameViewReview extends JViewLegacy
{
	protected $popularFeatures;
	protected $latestNews;
	protected $latestGames;
	protected $reviewsOfThisGame;
	protected $reviewsOfThisCategory;
	...
	function display($tpl = null)
	{
		...
		$this->reviewsOfThisGame = $this->get('ReviewsOfThisGame');
		$this->reviewsOfThisCategory = $this->get('ReviewsOfThisCategory');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($this->new->title . '|' . $this->item->name . " | Review");

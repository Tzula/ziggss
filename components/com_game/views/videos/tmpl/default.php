...
?>
	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="videos"> 
	<div id="sectionHeader" class="beefitup"><span><h1><?php echo $this->item->name . ' ';?>Videos</h1></span></div>
	<div class="gvpricon">
	...
	<?php if (!empty($this->items)) : ?>
			<?php foreach ($this->items as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=video&id=' . $this->item->id . '&videoid=' . $row->id);
			?>
			<div class="video">
					<div class="thumbnail"><a href="<?php echo $link;?>"><img src="/<?php echo json_decode($row->images)->image_intro;?>" alt="<?php echo $row->title;?>" width="102" height="73" border="0"></a></div>
					<ul class="details">
						<li class="title"><a href="<?php echo $link;?>"><?php echo $row->title;?></a>&nbsp;<span class="info"></span></li>
						<li class="info"><?php echo $row->hits;?> views&nbsp;&nbsp;<br><?php echo $row->created_by;?>, added on <?php echo JHtml::_('date', $row->created, JText::_('DATE_FORMAT_LC4')); ?></li>
						<li class="desc"><?php echo $row->introtext;?></li>
					</ul>
					<div class="clear"></div>
				</div>

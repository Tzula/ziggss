...
?>
	...
	<div class="gvew2">
		...
		<div class="navgvtwo">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_game&view=links&id=' . $this->item->id); ?>" class="links current" sl-processed="1"><span>Links</span></a>
	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="links"> 
	<div id="sectionHeader" class="beefitup"><span><h1><?php echo $this->item->name . ' ';?>Links</h1></span></div>
	<div class="gvpricon">
	...
	<div id="list">
			...
			<ul>
				<li><h2>Official Site</h2>
					<ul>
					<?php if (!empty($this->items)) : ?>
					<?php foreach ($this->items as $i => $row) :?>
					<?php if($row->linktype == 1):?>
					<?php unset($this->items[$i]);?>
					
						<li><h3>
						<a href="<?php echo $row->linkurl?>" target="_blank" sl-processed="1"><?php echo $row->name?></a>
						</h3><?php echo $row->description?></li>
					<?php endif;?>
					<?php endforeach;?>
					<?php endif;?>
					</ul>
		...
		<ul>
			<li><h2>Un-Official Links</h2>
				<ul>
				<?php if (!empty($this->items)) : ?>
					<?php foreach ($this->items as $i => $row) :?>
					<?php if($row->linktype == 0):?>

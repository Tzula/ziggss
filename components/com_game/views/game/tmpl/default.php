...
?>
	...
	<div class="gvew2">
		...
		<div class="hdrtwo" style="background: #59C8FF;">
			...
			<div class="ninfo">
				<div class="gvtitle"><div class="titleblock"><a href="<?php echo JRoute::_('index.php?option=com_game&view=game&id=' . $this->item->id); ?>" sl-processed="1"><?php echo $this->item->name;?></a><!-- <a href="http://www.mmorpg.com/gameRss.cfm?gameId=191" style="padding:0px 0px 0px 5px; position:relative; top:3px;" sl-processed="1"><img src="http://images.mmorpg.com/images/themes/radiance/rss_text_icon.gif" width="51" height="20" border="0" alt=""></a> --></div><div class="clear"></div></div>
		...
		<div class="navgvtwo">
			<a href="<?php echo JRoute::_('index.php?option=com_game&view=game&id=' . $this->item->id); ?>" class="overview current" sl-processed="1"><span>Overview</span></a>
	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="overview"> 
	<div id="sectionHeader" class="beefitup"><span><h1><?php echo $this->item->name;?></h1></span></div>
	<div class="gvpricon">


		<div class="body">
			<?php echo $this->item->overview;?>
		</div> 				
					<div style="height:10px; overflow:hidden;">&nbsp;</div>
				
				
				<!-- 
				<div class="ccfbox"><span class="ccfboxo"><span class="ccfboxi"><a href="http://www.mmorpg.com/gamelist.cfm/game/191/view/screens" class="title" sl-processed="1">Latest Screenshots</a></span></span></div>
				
				<div class="ccfboxcon screenshots">
					<script language="javascript" src="http://images.mmorpg.com/scripts/screenshots.js" type="text/javascript"></script> <ul> <li><a href="http://www.mmorpg.com/gamelist.cfm/game/191/view/screens/display/16999" title="" sl-processed="1"><img src="http://images.mmorpg.com/images/screenshots/082009/thumbs/16999.jpg" alt="" onmouseover="JSFX.fadeUp(this)" onmouseout="JSFX.fadeDown(this)" class="imageFader"></a>
							</li><li><a href="http://www.mmorpg.com/gamelist.cfm/game/191/view/screens/display/16998" title="" sl-processed="1"><img src="http://images.mmorpg.com/images/screenshots/082009/thumbs/16998.jpg" alt="" onmouseover="JSFX.fadeUp(this)" onmouseout="JSFX.fadeDown(this)" class="imageFader"></a>
							</li><li><a href="http://www.mmorpg.com/gamelist.cfm/game/191/view/screens/display/16997" title="" sl-processed="1"><img src="http://images.mmorpg.com/images/screenshots/082009/thumbs/16997.jpg" alt="" onmouseover="JSFX.fadeUp(this)" onmouseout="JSFX.fadeDown(this)" class="imageFader"></a>
							</li></ul>
				<a href="http://www.mmorpg.com/gamelist.cfm/game/191/view/screens" class="link" sl-processed="1">More Age of Conan: Unchained Screenshots...</a>
			</div> 
			 -->
			 
			 
			<div class="features"><h2>Latest Features</h2>
				<?php if (!empty($this->lastFeatures)) : ?>
						<?php foreach ($this->lastFeatures as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=feature&id=' . $this->item->id . '&newsid=' . $row->id);
						?>			
					<ul class="post">
						<li class="title"><a href="<?php echo $link;?>" sl-processed="1"><?php echo $row->title;?></a></li>
						<li class="date">created on <?php echo JHtml::_('date', $row->created, JText::_('DATE_FORMAT_LC4')); ?></li>
						<li class="overview"> <?php echo substr(strip_tags($row->text), 0, 500) . '...'; ?></li>
					</ul>
					<?php endforeach; ?>
			<?php endif; ?>
				...
				<a href="<?php echo JRoute::_('index.php?option=com_game&view=features&id=' . $this->item->id);?>" class="link" sl-processed="1">More <?php echo $this->item->name;?>: Unchained Features...</a>
			</div> 
	...
	<div class="gvpushcon">
			...
			<div id="moreContent" class="pushc"> <div class="section"><span class="pctitle">Popular Features:</span> 
				...
				<?php endif; ?>
					...
					<div class="section"><span class="pctitle">Latest News:</span> 

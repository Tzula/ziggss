...
?>
	...
	<div class="gvew2">
		...
		<div class="navgvtwo">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_game&view=features&id=' . $this->item->id); ?>" class="features current" sl-processed="1"><span>Features</span></a>
	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody ">
				...
				<div class="gvconblock">
						...
						<div class="news"> 
						<div id="sectionHeader"><span><h1><a href="/gamelist.cfm/game/421/view/news/page/1" sl-processed="1"><?php echo $this->item->name . ' ';?>Features</a> - <?php echo $this->new->title . ' ';?></h1>
	...
	<span style="display:none">Leave this field empty <input id="fpCFFC8009-3048-C53A-9498C39BECB2CC9A" type="text" name="formfield1234567894" value=""></span>
						...
						<br/>
				<br/>		
				<div class="features"><h2>Other Features Of This Game</h2>
					<ul class="spotlight">
						<?php if (!empty($this->featuresOfThisGame)) : ?>
						<?php $count = count($this->featuresOfThisGame);?>
						<?php foreach ($this->featuresOfThisGame as $i => $row) :
				...
				<div class="features"><h2>Other Features Of This Category</h2>
					<ul class="spotlight">
						<?php if (!empty($this->featuresOfThisCategory)) : ?>
						<?php $count = count($this->featuresOfThisCategory);?>
						<?php foreach ($this->featuresOfThisCategory as $i => $row) :
							$link = JRoute::_('index.php?option=com_game&view=feature&id=' . $row->gameid . '&newsid=' . $row->id);
							$img = json_decode($row->images)->image_intro;
							if ($img == ''){
								$img = 'media/other/generic.png';

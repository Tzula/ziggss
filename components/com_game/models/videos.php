 ...
 * @since  0.0.1
 */
class GameModelVideos extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->select(
				$this->getState(
						'list.select',
						'a.id, a.title, a.alias, a.catid, a.state, a.introtext, a.access, a.created, a.created_by, a.created_by_alias, a.hits, a.images'
				)
		);
		...
		$query->where('catid = 19 or catid= 58 or catid=59 or catid=61 or catid=62');

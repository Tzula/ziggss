 ...
 * @since  0.0.1
 */
class GameModelNew extends JModelItem
{
	/**
	...
	public function getNewsOfThisGame(){
		// Create a new query object.
		$db = $this->getDbo();
		$query = $db->getQuery(true);
		$user = JFactory::getUser();
		...
		$sql = "select * from #__content as a where a.state=1 and a.catid =18 and a.gameid=$gameid  order by a.created desc limit 4";
	...
	public function getNewsOfThisCategory(){
		// Create a new query object.
		$db = $this->getDbo();
		$query = $db->getQuery(true);
		$user = JFactory::getUser();
		...
		$sql = "select * from #__content as a where a.state=1 and a.catid =18 and a.gameid in (select b.id from #__game as b  where b.genres=$gameCid )  order by a.created desc limit 4";

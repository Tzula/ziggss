...
<div id="features" class="feetures">
	...
	<div class="panelOuterBody">
		...
		<script>
			function filterFeature() {
				...
				if(theForm.gameId.value == 0){
					var theTarget = "/index.php/component/content/?view=general&cid=" + <?php echo $this->cid;?>;
				}
				else {
					var theTarget = "/index.php/component/content/?view=general&cid=" + <?php echo $this->cid;?> + "&gameid="+theForm.gameId.value;
				}
		...
		<form action="index.php?option=com_content&view=general&cid=<?php echo $this->cid;?>&gameid=<?php echo $this->gameid; ?>" method="post" id="adminForm" name="adminForm">
		<div class="list">

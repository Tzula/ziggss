...
//print_r($this->topic);
//die();
$avatar = PlgUserCMAvatarHelper::getAvatar($this->topic->first_post_userid);
if ($avatar == ''){
	$avatar = 'http://www.gameteaser.com/media/kunena/avatars/resized/size36/./s_nophoto.jpg">';
}
?>
	...
	<ul class="klatest-itemdetails">
		...
		if ($this->params->get('sh_topiciconoravatar') == 1) : ?>
			<li class="klatest-avatar">
				<img src="<?php echo $avatar;?>" alt="Avatar" width="35px" height="35px">

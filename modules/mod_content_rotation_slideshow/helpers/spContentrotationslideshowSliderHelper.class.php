...
* @license		http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
    */
    ...
    class spContentrotationslideshowSliderHelper
    {

        public $name = 'Element';
        public $uniqid   = 'Contentrotationslideshow';
        public $fieldname;
        public $params;
        public function setOptions()
        {
            ...
            $html[] = array(
                ...
                'html'=>'<textarea  name="jform[params]['.$this->fieldname.']['.$this->uniqid.'][titleshort][]">'.$this->params['titleshort'].'</textarea>'
			);
			$html[] = array(
                'title'=>'title long',
                'tip'=>'title long',
                ...
                'attrs'=>'',
                'fieldname'=>'titlelong',
                'html'=>'<textarea  name="jform[params]['.$this->fieldname.']['.$this->uniqid.'][titlelong][]">'.$this->params['titlelong'].'</textarea>'
			);

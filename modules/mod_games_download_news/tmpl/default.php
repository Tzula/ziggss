	...
	<div class="panelOuterBody">
		...
		<div id="" class="panelBody "> 
			<div class="upcomgamebox">
				<div class="ccfbox"><span class="ccfboxo"><span class="ccfboxi">MMOs and Games to Play, Download or Pre-Order Now!</span></span></div>
					<div class="ccfboxcon">
					<ul>
					...
					?>
					<li style="background:transparent url(<?php echo $img;?>) no-repeat center left;background-size:26px 26px;"><a href="<?php echo $item->playnowlink; ?>" rel="nofollow"><?php echo $item->name;?></a></li>
				<?php endforeach; ?>
